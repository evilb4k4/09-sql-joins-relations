...
app.post('/articles', function(request, response) {
  ...
  function queryThree(author_id) {
    client.query(
      `INSERT INTO articles(author_id, author, authorUrl, category, publishedOn, body)
      VALUES ($1, $2, $3, $4, $5, $6 )`, // TODO: Write a SQL query to insert the new article using the author_id from our previous query
      [ author_id,
        request.body.author,
        request.body.authorUrl,
